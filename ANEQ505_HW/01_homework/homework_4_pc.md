...
```
Happened to me before, taxonomy_gg2.qza does not exist but is meant to be taxonomy_gg2_filtered.qza
Command ran and worked...slay
...
The body site that I found to be the most different was nasal. The nasal cavity provides a completely different environment compared to skin, udder, and even oral. Nasal constantly has airflow and is exposed to outside elements constantly. Additionally, the nasal has mucus passing through 
